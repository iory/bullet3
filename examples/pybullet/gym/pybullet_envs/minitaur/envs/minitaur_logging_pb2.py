...
_MINITAUREPISODE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='state_action',
            full_name=
            'robotics.reinforcement_learning.minitaur.envs.MinitaurEpisode.state_action',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_MINITAURMOTORSTATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='angle',
            full_name=
            'robotics.reinforcement_learning.minitaur.envs.MinitaurMotorState.angle',
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='velocity',
            full_name=
            'robotics.reinforcement_learning.minitaur.envs.MinitaurMotorState.velocity',
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='torque',
            full_name=
            'robotics.reinforcement_learning.minitaur.envs.MinitaurMotorState.torque',
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='action',
            full_name=
            'robotics.reinforcement_learning.minitaur.envs.MinitaurMotorState.action',
            index=3,
            number=4,
            type=1,
            cpp_type=5,
...
_MINITAURSTATEACTION = _descriptor.Descriptor(
    ...
    full_name=
    'robotics.reinforcement_learning.minitaur.envs.MinitaurStateAction',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='time',
            full_name=
            'robotics.reinforcement_learning.minitaur.envs.MinitaurStateAction.time',
            index=1,
            number=1,
            type=11,
            cpp_type=10,
...
_MINITAUREPISODE.fields_by_name[
    'state_action'].message_type = _MINITAURSTATEACTION
_MINITAURSTATEACTION.fields_by_name[
    'time'].message_type = timestamp__pb2._TIMESTAMP
_MINITAURSTATEACTION.fields_by_name[
    'base_position'].message_type = vector__pb2._VECTOR3D
_MINITAURSTATEACTION.fields_by_name[
    'base_orientation'].message_type = vector__pb2._VECTOR3D
_MINITAURSTATEACTION.fields_by_name[
    'base_angular_vel'].message_type = vector__pb2._VECTOR3D
_MINITAURSTATEACTION.fields_by_name[
    'motor_states'].message_type = _MINITAURMOTORSTATE
