...
class HumanoidPose(object):
  ...
  def ComputeLinVel(self, posStart, posEnd, deltaTime):
    vel = [(posEnd[0] - posStart[0]) / deltaTime,
  ...
  def NormalizeQuaternion(self, orn):
    length2 = orn[0] * orn[0] + orn[1] * orn[1] + orn[2] * orn[2] + orn[
        3] * orn[3]
    if (length2 > 0):
  ...
  def PostProcessMotionData(self, frameData):
    ...
    rightHipRotStart = [
        frameData[17], frameData[18], frameData[19], frameData[16]
    ]
    rightAnkleRotStart = [
        frameData[22], frameData[23], frameData[24], frameData[21]
    ]
    rightShoulderRotStart = [
        frameData[26], frameData[27], frameData[28], frameData[25]
    ]
    leftHipRotStart = [
        frameData[31], frameData[32], frameData[33], frameData[30]
    ]
    leftAnkleRotStart = [
        frameData[36], frameData[37], frameData[38], frameData[35]
    ]
    leftShoulderRotStart = [
        frameData[40], frameData[41], frameData[42], frameData[39]
    ]
  ...
  def Slerp(self, frameFraction, frameData, frameDataNext, bullet_client):
    ...
    self._baseLinVel = self.ComputeLinVel(basePos1Start, basePos1End,
                                          keyFrameDuration)
    baseOrn1Start = [frameData[5], frameData[6], frameData[7], frameData[4]]
    baseOrn1Next = [
        frameDataNext[5], frameDataNext[6], frameDataNext[7], frameDataNext[4]
    ]
    self._baseOrn = bullet_client.getQuaternionSlerp(
        baseOrn1Start, baseOrn1Next, frameFraction)
    self._baseAngVel = self.ComputeAngVel(baseOrn1Start, baseOrn1Next,
    ...
    chestRotStart = [frameData[9], frameData[10], frameData[11], frameData[8]]
    chestRotEnd = [
        frameDataNext[9], frameDataNext[10], frameDataNext[11], frameDataNext[8]
    ]
    self._chestRot = bullet_client.getQuaternionSlerp(
        chestRotStart, chestRotEnd, frameFraction)
    self._chestVel = self.ComputeAngVel(chestRotStart, chestRotEnd,
                                        keyFrameDuration, bullet_client)

    neckRotStart = [frameData[13], frameData[14], frameData[15], frameData[12]]
    neckRotEnd = [
        frameDataNext[13], frameDataNext[14], frameDataNext[15],
        frameDataNext[12]
    ]
    self._neckRot = bullet_client.getQuaternionSlerp(neckRotStart, neckRotEnd,
                                                     frameFraction)
    self._neckVel = self.ComputeAngVel(neckRotStart, neckRotEnd,
                                       keyFrameDuration, bullet_client)
    ...
    rightHipRotEnd = [
        frameDataNext[17], frameDataNext[18], frameDataNext[19],
        frameDataNext[16]
    ]
    self._rightHipRot = bullet_client.getQuaternionSlerp(
        rightHipRotStart, rightHipRotEnd, frameFraction)
    self._rightHipVel = self.ComputeAngVel(rightHipRotStart, rightHipRotEnd,
                                           keyFrameDuration, bullet_client)
    ...
    self._rightKneeRot = [
        rightKneeRotStart[0] +
        frameFraction * (rightKneeRotEnd[0] - rightKneeRotStart[0])
    ]
    self._rightKneeVel = [
        (rightKneeRotEnd[0] - rightKneeRotStart[0]) / keyFrameDuration
    ]
    ...
    rightAnkleRotEnd = [
        frameDataNext[22], frameDataNext[23], frameDataNext[24],
        frameDataNext[21]
    ]
    self._rightAnkleRot = bullet_client.getQuaternionSlerp(
        rightAnkleRotStart, rightAnkleRotEnd, frameFraction)
    self._rightAnkleVel = self.ComputeAngVel(
        rightAnkleRotStart, rightAnkleRotEnd, keyFrameDuration, bullet_client)

    rightShoulderRotStart = [
        frameData[26], frameData[27], frameData[28], frameData[25]
    ]
    rightShoulderRotEnd = [
        frameDataNext[26], frameDataNext[27], frameDataNext[28],
        frameDataNext[25]
    ]
    self._rightShoulderRot = bullet_client.getQuaternionSlerp(
        rightShoulderRotStart, rightShoulderRotEnd, frameFraction)
    self._rightShoulderVel = self.ComputeAngVel(rightShoulderRotStart,
                                                rightShoulderRotEnd,
                                                keyFrameDuration, bullet_client)
    ...
    self._rightElbowRot = [
        rightElbowRotStart[0] +
        frameFraction * (rightElbowRotEnd[0] - rightElbowRotStart[0])
    ]
    self._rightElbowVel = [
        (rightElbowRotEnd[0] - rightElbowRotStart[0]) / keyFrameDuration
    ]
    ...
    leftHipRotEnd = [
        frameDataNext[31], frameDataNext[32], frameDataNext[33],
        frameDataNext[30]
    ]
    self._leftHipRot = bullet_client.getQuaternionSlerp(
        leftHipRotStart, leftHipRotEnd, frameFraction)
    self._leftHipVel = self.ComputeAngVel(leftHipRotStart, leftHipRotEnd,
                                          keyFrameDuration, bullet_client)
    ...
    self._leftKneeRot = [
        leftKneeRotStart[0] +
        frameFraction * (leftKneeRotEnd[0] - leftKneeRotStart[0])
    ]
    self._leftKneeVel = [
        (leftKneeRotEnd[0] - leftKneeRotStart[0]) / keyFrameDuration
    ]
    ...
    leftAnkleRotEnd = [
        frameDataNext[36], frameDataNext[37], frameDataNext[38],
        frameDataNext[35]
    ]
    self._leftAnkleRot = bullet_client.getQuaternionSlerp(
        leftAnkleRotStart, leftAnkleRotEnd, frameFraction)
    self._leftAnkleVel = self.ComputeAngVel(leftAnkleRotStart, leftAnkleRotEnd,
                                            keyFrameDuration, bullet_client)
    ...
    leftShoulderRotEnd = [
        frameDataNext[40], frameDataNext[41], frameDataNext[42],
        frameDataNext[39]
    ]
    self._leftShoulderRot = bullet_client.getQuaternionSlerp(
        leftShoulderRotStart, leftShoulderRotEnd, frameFraction)
    self._leftShoulderVel = self.ComputeAngVel(leftShoulderRotStart,
                                               leftShoulderRotEnd,
                                               keyFrameDuration, bullet_client)
    ...
    self._leftElbowRot = [
        leftElbowRotStart[0] +
        frameFraction * (leftElbowRotEnd[0] - leftElbowRotStart[0])
    ]
    self._leftElbowVel = [
        (leftElbowRotEnd[0] - leftElbowRotStart[0]) / keyFrameDuration
    ]
...
class Humanoid(object):
  ...
  def RenderReference(self, t):
    ...
    pose = HumanoidPose()
    pose.Slerp(self._frameFraction, frameData, frameDataNext,
  ...
  def SetSimTime(self, t):
    ...
    self._frameFraction = (frameTime - self._frame * keyFrameDuration) / (
        keyFrameDuration)
  ...
  def BuildHeadingTrans(self, rootOrn):
    ...
    headingOrn = self._pybullet_client.getQuaternionFromAxisAngle([0, 1, 0],
                                                                  -heading)
    return headingOrn
  ...
  def BuildOriginTrans(self):
    ...
    invOrigTransPos, invOrigTransOrn = self._pybullet_client.multiplyTransforms(
        [0, 0, 0], headingOrn, invRootPos, [0, 0, 0, 1])
    # print("invOrigTransPos=",invOrigTransPos)
    # print("invOrigTransOrn=",invOrigTransOrn)
    invOrigTransMat = self._pybullet_client.getMatrixFromQuaternion(
        invOrigTransOrn)
  ...
  def ApplyAction(self, action):
    ...
    index += 4
    pose._chestRot = self._pybullet_client.getQuaternionFromAxisAngle(
        axis, angle)
    ...
    axis = [action[index + 1], action[index + 2], action[index + 3]]
    index += 4
    pose._neckRot = self._pybullet_client.getQuaternionFromAxisAngle(
        axis, angle)

    angle = action[index]
    axis = [action[index + 1], action[index + 2], action[index + 3]]
    index += 4
    pose._rightHipRot = self._pybullet_client.getQuaternionFromAxisAngle(
        axis, angle)
    ...
    axis = [action[index + 1], action[index + 2], action[index + 3]]
    index += 4
    pose._rightAnkleRot = self._pybullet_client.getQuaternionFromAxisAngle(
        axis, angle)

    angle = action[index]
    axis = [action[index + 1], action[index + 2], action[index + 3]]
    index += 4
    pose._rightShoulderRot = self._pybullet_client.getQuaternionFromAxisAngle(
        axis, angle)
    ...
    axis = [action[index + 1], action[index + 2], action[index + 3]]
    index += 4
    pose._leftHipRot = self._pybullet_client.getQuaternionFromAxisAngle(
        axis, angle)
    ...
    axis = [action[index + 1], action[index + 2], action[index + 3]]
    index += 4
    pose._leftAnkleRot = self._pybullet_client.getQuaternionFromAxisAngle(
        axis, angle)

    angle = action[index]
    axis = [action[index + 1], action[index + 2], action[index + 3]]
    index += 4
    pose._leftShoulderRot = self._pybullet_client.getQuaternionFromAxisAngle(
        axis, angle)
  ...
  def ApplyPose(self, pose, initializeBase, initializeVelocities, humanoid, bc):
    ...
    if (initializeBase):
      ...
      basePos = [
          pose._basePos[0] + self._baseShift[0],
          pose._basePos[1] + self._baseShift[1],
    ...
    if (initializeBase):
      if initializeVelocities:
        ...
        bc.resetJointStateMultiDof(humanoid, rightAnkle, pose._rightAnkleRot,
                                   pose._rightAnkleVel)
        bc.resetJointStateMultiDof(humanoid, rightShoulder,
                                   pose._rightShoulderRot,
        ...
        bc.resetJointStateMultiDof(humanoid, leftAnkle, pose._leftAnkleRot,
                                   pose._leftAnkleVel)
        bc.resetJointStateMultiDof(humanoid, leftShoulder,
  ...
  def GetState(self):
    ...
    rootPosRel, dummy = self._pybullet_client.multiplyTransforms(
        rootTransPos, rootTransOrn, basePos, [0, 0, 0, 1])
    #print("!!!rootPosRel =",rootPosRel )
    # print("rootTransPos=",rootTransPos)
    # print("basePos=",basePos)
    localPos, localOrn = self._pybullet_client.multiplyTransforms(
        rootTransPos, rootTransOrn, basePos, baseOrn)

    localPos = [
        localPos[0] - rootPosRel[0], localPos[1] - rootPosRel[1],
        localPos[2] - rootPosRel[2]
    ]
    ...
    for pbJoint in range(self._pybullet_client.getNumJoints(self._humanoid)):
      ...
      #print("joint order:",j)
      ls = self._pybullet_client.getLinkState(
          self._humanoid, j, computeForwardKinematics=True)
      linkPos = ls[0]
      linkOrn = ls[1]
      ...
      if (linkOrnLocal[3] < 0):
        linkOrnLocal = [
            -linkOrnLocal[0], -linkOrnLocal[1], -linkOrnLocal[2],
            -linkOrnLocal[3]
        ]
      linkPosLocal = [
    ...
    for pbJoint in range(self._pybullet_client.getNumJoints(self._humanoid)):
      j = self.pb2dmJoints[pbJoint]
      ls = self._pybullet_client.getLinkState(
          self._humanoid, j, computeLinkVelocity=True)
      linkLinVel = ls[6]
      linkAngVel = ls[7]
      for l in linkLinVel:
        stateVector.append(l)
  ...
  def GetReward(self):
    ...
    mJointWeights = [
        0.20833, 0.10416, 0.0625, 0.10416, 0.0625, 0.041666666666666671, 0.0625,
        0.0416, 0.00, 0.10416, 0.0625, 0.0416, 0.0625, 0.0416, 0.0000
    ]
    ...
    for j in range(num_joints):
      ...
      kinJointInfo = self.kin_client.getJointStateMultiDof(
          self._kinematicHumanoid, j)
      ...
      if (len(simJointInfo[0]) == 4):
        ...
        curr_vel_err = diffVel[0] * diffVel[0] + diffVel[1] * diffVel[
            1] + diffVel[2] * diffVel[2]
    ...
    reward = pose_w * pose_reward + vel_w * vel_reward + end_eff_w * \
        end_eff_reward + root_w * root_reward + com_w * com_reward
