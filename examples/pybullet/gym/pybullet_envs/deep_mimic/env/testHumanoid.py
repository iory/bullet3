...
planeId = pybullet_client.loadURDF(
  ...
  if animating or singleStep:
    ...
    for i in range(1):
      ...
      maxForces = [
          ...
          200, 200, 150, 90, 90, 90, 90, 100, 100, 100, 100, 60, 200, 200, 200,
          200, 150, 90, 90, 90, 90, 100, 100, 100, 100, 60
      ]
      taus = humanoid.computePDForces(
          desiredPose, desiredVelocities=None, maxForces=maxForces)
