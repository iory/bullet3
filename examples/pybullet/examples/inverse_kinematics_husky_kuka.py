...
def accurateCalculateInverseKinematics(kukaId, endEffectorId, targetPos,
                                       threshold, maxIter):
  closeEnough = False
  iter = 0
  dist2 = 1e30
  while (not closeEnough and iter < maxIter):
    ...
    newPos = ls[4]
    diff = [
        targetPos[0] - newPos[0], targetPos[1] - newPos[1],
  ...
  for i in range(1):
    ...
    if (useNullSpace == 1):
      ...
      if (useOrientation == 1):
        ...
        threshold = 0.001
        maxIter = 100
        jointPoses = accurateCalculateInverseKinematics(
            kukaId, kukaEndEffectorIndex, pos, threshold, maxIter)
