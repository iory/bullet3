...
def getRayFromTo(mouseX, mouseY):
  ...
  invLen = farPlane * 1. / (
      math.sqrt(rayForward[0] * rayForward[0] + rayForward[1] * rayForward[1] +
  ...
  rayTo = [
      rayFrom[0] + rayForward[0] - 0.5 * horizon[0] + 0.5 * vertical[0] +
      float(mouseX) * dHor[0] - float(mouseY) * dVer[0],
      rayFrom[1] + rayForward[1] - 0.5 * horizon[1] + 0.5 * vertical[1] +
...
uvs = [[0.750000, 0.250000], [1.000000, 0.250000], [1.000000, 0.000000],
       [0.750000, 0.000000], [0.500000, 0.250000], [0.250000, 0.250000],
       [0.250000, 0.000000], [0.500000, 0.000000], [0.500000, 0.000000],
       [0.750000, 0.000000], [0.750000, 0.250000], [0.500000, 0.250000],
       [0.250000, 0.500000], [0.250000, 0.250000], [0.000000, 0.250000],
       [0.000000, 0.500000], [0.250000, 0.500000], [0.250000, 0.250000],
       [0.500000, 0.250000], [0.500000, 0.500000], [0.000000, 0.000000],
       [0.000000, 0.250000], [0.250000, 0.250000], [0.250000, 0.000000]]
indices = [
    0,
    1,
    2,
