...
p.setJointMotorControl2(
    minitaur, motorJointId, p.VELOCITY_CONTROL, targetVelocity=100000, force=0)
...
jointFrictionForceSlider = p.addUserDebugParameter("jointFrictionForce", 0, 0.1,
                                                   0)
...
while (1):
  ...
  p.setJointMotorControl2(
      ...
      force=frictionForce)
  p.changeDynamics(
      minitaur, motorJointId, linearDamping=0, angularDamping=angularDamping)
