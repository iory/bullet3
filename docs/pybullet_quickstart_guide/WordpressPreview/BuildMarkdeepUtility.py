...
if (__name__ == "__main__"):
  ...
  DocumentBodySuffix = FullPreviewBody[iArticleHTMLCodeMacro +
                                       len(ArticleHTMLCodeMacro):]
  ...
  for Element, AttributeCode in [("head", HeadAttributes),
                                 ("body", BodyAttributes)]:
  ...
  SourceFileList = [
      "PrepareHTML.full.js", "SetMarkdeepMode.js", "markdeep.min.js",
      "DisplayMarkdeepOutput.js", "InvokeMathJax.js"
  ]
  OutputCode = "\r\n\r\n".join([
      "// " + SourceFile + "\r\n\r\n" + open(SourceFile,
